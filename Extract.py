...
for x in range(30):
    t1=time.time()
    extractorO(round(7.0+0.1*x,1),"z020","/g/lu/scratch/ryotainagaki/BPASS_tester_old_style/","/g/lu/scratch/ryotainagaki/BPASS_iso_filesTimed/",0.05)
    t2=time.time()
    print(t2-t1)
...
for x in range(30):
    t1=time.time()
    extractor(round(7.0+0.1*x,1),"z020","/g/lu/scratch/ryotainagaki/BPASS_tester_newReformatTest/","/g/lu/scratch/ryotainagaki/BPASS_iso_filesTimedIsolated/",0.05)
    t2=time.time()
    print(t2-t1)